...
class courseItem {
	...
	public function save() {
		...
		$db->query('insert into course (course, course_id, teacher_id, classroon, teacher_time
		total_time, course_year_term, property, credit, intro) values(\''.$this->Course.'\', \''.$this->Course_ID.'
	...
	public function update($arg) {
		...
		$req = array('Course_ID', $this->Course_ID);
		$table = 'course';
