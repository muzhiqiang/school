<div class='col-xs-2' id="leftSection">
	<ul class='nav nav-pills nav-stacked text-center'>
		...
		<li id ="stu_orgnz">
			<a class='row' href="./stu_orgnz.php">
				<p class='navbar-font'>学生组织</p>
			</a>
		</li>
		<li id ="stu_manage_class">
			<a class='row' href="./stu_manage_class.php">
				<p class='navbar-font'>班级管理</p>
			</a>
		</li>
		<li id  ="stu_research">
			<a class='row' href="./stu_research.php">
